...
def PredGambar(file_gmbr):
    ...
    Kualitas = ['JamurKancing', 'JamurKuping', 'JamurTiram']
    df['Kelas'] = Kualitas
    ...
    if predik_kelas == 0:
        predik_Kualitas = 'JamurKancing'
    elif predik_kelas == 1:
        predik_Kualitas = 'JamurKuping' 
    else:
        predik_Kualitas = 'JamurTiram'
...
NUM_CLASSES = 3
cifar10_classes = ["JamurKancing", "JamurKuping", "JamurTiram"]
